...
void set_current_antinodes(Tile *map, Tile *loc)
{
	...
	while (aux)
	{
		...
		{
			int times = 1;
			Tile *new_antinode1 = access(map, loc->loc_x - times * (aux->loc_x - loc->loc_x), loc->loc_y - times * (aux->loc_y - loc->loc_y));
			do
			{
				times++;
				if (new_antinode1)
				...
				new_antinode1 = access(map, loc->loc_x - times * (aux->loc_x - loc->loc_x), loc->loc_y - times * (aux->loc_y - loc->loc_y));
			}
			while (new_antinode1);
			
			times = 1;
			Tile *new_antinode2 = access(map, aux->loc_x + times * (aux->loc_x - loc->loc_x), aux->loc_y + times * (aux->loc_y - loc->loc_y));
			do
			{
				times++;
				if (new_antinode2)
				...
				new_antinode2 = access(map, aux->loc_x + times * (aux->loc_x - loc->loc_x), aux->loc_y + times * (aux->loc_y - loc->loc_y));
			}
			while (new_antinode2);
